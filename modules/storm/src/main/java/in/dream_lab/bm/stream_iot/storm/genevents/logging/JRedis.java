...
public class JRedis{
    ...
    String HOSTNAME="redis";  //Naming it to connect to redis-conatiner
	...
	this.jedis = new Jedis(this.HOSTNAME, 6379,60000);  //Changing Redis timeout from default 2 seconds to 60 seconds
